...
class UndoVerticesUpdaterPanel(bpy.types.Panel):
    bl_label = "Updater UndoVertices Panel"
    bl_idname = "OBJECT_PT_UndoVerticesUpdaterPanel"
    ...
    def draw(self, context):
        ...
        layout.label(text="UndoVertices Updater Addon")
        layout.label(text="")
...
class UndoVerticesPreferences(bpy.types.AddonPreferences):
    """UndoVertices bare-bones preferences"""
